...
export function ButtonWhatsapp({ whatsappNumber }: ButtonWhatsappProps) {
  ...
  const message =
    "Ola! Vim pelo site de Krav Maga em Jau/SP e quero agendar uma aula experimental com o Coach Erick Reghine.";
  ...
  return (
    <Link
      ...
      target="_blank"
      rel="noreferrer"
      aria-label="WhatsApp Krav Maga em Jau SP - agendar aula experimental"
    ...
    >
      <span className="pointer-events-none absolute right-16 top-1/2 w-52 -translate-y-1/2 rounded-lg bg-foreground px-3 py-1 text-xs font-medium text-background opacity-0 shadow transition group-hover:opacity-100">
        Atendimento humano em Jau/SP para aula experimental
      </span>
